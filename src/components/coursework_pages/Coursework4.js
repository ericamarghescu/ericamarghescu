      ...
      return (
         <div className="coursework4">
            ...
            <div className="coursework4-right">
               ...
               {this.state.c3 ? (<p className="coursework4-course-name">French Grammar and Composition</p>) : (<div/>)}
               {this.state.c3 ? (<p className="coursework4-course-desc">Intensive study of French grammar and composition.</p>) : (<div/>)}
               {this.state.c4 ? (<p className="coursework4-course-name">Cybersecurity Data Analysis</p>) : (<div/>)}
               {this.state.c4 ? (<p className="coursework4-course-desc">Focuses on exploratory and statistical data analysis, data and information visualization, and the presentation and communication of analysis results. These topics will be presented and explored in the context of and with applications to cyber security related data. Examples and illustrations will often involve the R programming language, but prior experience with R is not required and submitted work may involve the use of other languages and tools at times.</p>) : (<div/>)}
               {this.state.c5 ? (<p className="coursework4-course-name">Introduction to Matlab</p>) : (<div/>)}
               {this.state.c5 ? (<p className="coursework4-course-desc">This course is intended to prepare students for subsequent courses requiring computation with MATLAB. Covers basics of MATLAB including simple commands, variables, solving equations, graphing differentiation and integration, matrices and vectors, functions, M-files and fundamentals of programming in the MATLAB environment.</p>) : (<div/>)}
               {this.state.c6 ? (<p className="coursework4-course-name">Elements of Nutrition</p>) : (<div/>)}
               {this.state.c6 ? (<p className="coursework4-course-desc">Fundamentals of human nutrition. Nutrient requirements related to changing individual and family needs.</p>) : (<div/>)}
            </div>
         </div>
       );
   }
