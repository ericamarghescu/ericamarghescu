      ...
      return (
         <div className="coursework1">
            ...
            <div className="coursework1-right">
               ...
               {this.state.c5 ? (<p className="coursework1-course-name">Introduction to Sociology</p>) : (<div/>)}
               {this.state.c5 ? (<p className="coursework1-course-desc">The fundamental concepts and principles of sociology. Includes consideration of culture, patterns of social interaction, norms, values, social institutions, stratification, and social change.</p>) : (<div/>)}
            </div>
         </div>
       );
   }
